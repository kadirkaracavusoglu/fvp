...
// Sonunda iletişim → /api/basvuru → /vaka-hande/randevu takvim sayfasına yönlendir.
...
export default function VakaHandeBasvuruPage() {
  ...
  useEffect(() => {
    ...
    if (!started.current) {
      ...
      track("vsl_basvuru_start", { location: "vaka-hande" });
  ...
  useEffect(() => {
    ...
    track(`vsl_basvuru_s${n}`, { location: "vaka-hande", question });
    trackServer(`vsl_basvuru_s${n}`, { meta: { step: n, question } });
    if (question === "iletisim") {
      track("vsl_basvuru_contact_view", { location: "vaka-hande" });
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      track("vsl_basvuru_submit", { location: "vaka-hande" });
      trackServer("vsl_basvuru_submit");
      router.push("/vaka-hande/randevu");
    } catch {
