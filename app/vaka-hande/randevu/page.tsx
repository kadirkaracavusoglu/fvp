...
export default function VakaHandeRandevuPage() {
  ...
  useBookingRedirect("vaka-hande", "/vaka-hande/tesekkurler");
  ...
  useEffect(() => {
    ...
    track("vsl_calendar_view", { location: "vaka-hande" });
    ...
    <div className="glow-bg min-h-screen px-5 py-10 sm:py-14">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="overflow-hidden rounded-2xl border border-[#e6e8ea] bg-white shadow-xl">
          <iframe
            id="SSw6HZHR3j9veTWH8xTp_vaka_hande"
            src={calendarUrl}
            ...
            onLoad={() => {
              track("vsl_calendar_loaded", { location: "vaka-hande" });
